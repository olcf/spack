...
def concretize(abstract_spec):
    return spack.concretize.concretize(Spec(abstract_spec))
...
"""
    ...
    def test_preferred(self):
        ...
        spec = spack.concretize.concretize(Spec("python"))
    ...
    def test_develop(self):
        ...
        spec = spack.concretize.concretize(Spec("develop-test"))
        assert spec.version == Version("0.2.15")
        spec = spack.concretize.concretize(Spec("develop-test2"))
        assert spec.version == Version("0.2.15")
    ...
    def test_external_mpi(self):
        ...
        spec = spack.concretize.concretize(Spec("mpi"))
...
"""
    ...
    def test_variant_not_flipped_to_pull_externals(self):
        ...
        """
        s = spack.concretize.concretize(Spec("vdefault-or-external-root"))
    ...
    def test_multivalued_variants_are_lower_priority_than_providers(self):
        ...
        with spack.config.override(
            ...
            s = spack.concretize.concretize(Spec("somevirtual"))
    ...
    def test_sticky_variant_accounts_for_packages_yaml(self):
        with spack.config.override("packages:sticky-variant", {"variants": "+allow-gcc"}):
            s = spack.concretize.concretize(Spec("sticky-variant %gcc"))
